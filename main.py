...
YELLOW_SPACESHIP = pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HIEGHT))
YELLOW_SPACESHIP = pygame.transform.rotate(YELLOW_SPACESHIP, 90)
RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_red.png'))
RED_SPACESHIP = pygame.transform.scale(RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HIEGHT))
...
def red_handle_movement(keys_pressed, ship):
    if keys_pressed[pygame.K_LEFT] and ship.x - VEL > BORDER.x +20: #left
        ship.x -= VEL
    if keys_pressed[pygame.K_RIGHT] and ship.x + VEL + ship.width < WIDTH +10: #right
        ship.x += VEL
    if keys_pressed[pygame.K_UP] and ship.y - VEL > 0: #up
        ship.y -= VEL
    if keys_pressed[pygame.K_DOWN] and ship.y + VEL + ship.height < HEIGHT - 15: #down
        ship.y += VEL
